...
int main()
{
    ...
    Date d3(2020, 1, 15, 11, 3);
    Date d4(2020, 1, 15, 14, 3);
    testDate(d3, d4, false);
    
    Date d5(2020, 1, 15, 11, 1);
    Date d6(2020, 1, 15, 12, 3);
    testDate(d5, d6, false);
    
    Date d7(2020, 1, 15, 11, 3);
    Date d8(2020, 1, 15, 12, 3);
    testDate(d7, d8, true);
    
    Date d9(2020, 1, 15, 11, 3);
    Date d10(2020, 1, 15, 11, 3);
